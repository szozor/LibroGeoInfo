...
\node at (1,.75){\includegraphics[width=4cm]{TIKZ_SZ/CapacidadBinaria}};
...
%
\node[scale=.8] at (2.075,.02){\small 0};
\node[scale=.8] at (2.075,1.48){\small 1};
\end{scope}
%
%
% ----- Canal simetrico
...
--(1,1);
%
\node[scale=.8] at (.5,.75){\small $(\vartheta = \varepsilon)$};
...
-- (1,0);
%
\node[scale=.8] at (.75,.75){\small $(\varepsilon = 0)$};
\draw (1,0)--(1,-.05) node[below,scale=.8]{\small 1};
\draw (0,1)--(-.05,1) node[left,scale=.8]{\small 1};
\end{scope}
\node at (.8,-.4){\small (a)};
\node at (3.85,-.4){\small (b)};
\node at (6.75,-.4){\small (c)};
\end{tikzpicture}
