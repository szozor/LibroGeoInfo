\capitulo{Elementos de teor\'ia de probabilidades}{Mariela Portesi}
\label{cap:teoriaprobabilidades}

% Epigrafe de capitulo (si quieren) ============================================
\begin{epigrafe}
  \textcolor{red}{Esto  es  un  ep\'igrafe  con  texto simulado.\\  Esto  es  un
    ep\'igrafe con  texto simulado.  \autortituloepigrafe{Autor  del ep\'igrafe,
      T\'itulo de la obra} }
\end{epigrafe}


% Seccion ======================================================================
\seccion{Variables aleatorias}
\label{sec:var_aleat}
...
% Subseccion -------------------------------------------------------------------
\subseccion{Una subsecci\'on}
\label{subsec:var_aleat_sub}
...
% Seccion ======================================================================
\seccion{Distribuciones de probablidad discretas}
...
% Subsubseccion ----------------------------------------------------------------
\subsubseccion{Una subsubsecci\'on}
\label{subsubsec:var_aleat_subsub}
