...
\begin{proof}
  ...
  \tq g \: \mbox{es medible con} \and g(X) \: \mbox{es de cuadrado integrable}\}$.
...
\begin{figure}[h!]
  ...
  \leyenda{Ilustraci\'on del  teorema de  proyecci\'on ortogonal.  El  espacio \
    $\sigma^2(X) = \{ g(X) \tq g \: \mbox{es medible con} \and g(X) \: \mbox{es de
      cuadrado  integrable}\}$  \ es  representado  por  el  plano y  el  vector
