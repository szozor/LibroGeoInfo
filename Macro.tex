...
\def\Asim{\operatorname{Sesgo}} % Asimetria {\operatorname{Asim}}
...
\newcommand{\bino}[2]{\left( \hspace{-2mm} \protect\begin{array}{c} #1 \\[-1.5mm] #2 \protect\end{array} \hspace{-2mm} \right)}
