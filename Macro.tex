...
\def\TriS{\mathrm{T}^\vartriangle} % matrices triangular superior
...
\def\grad{\operatorname{grad}}% gradiante
\def\div{\operatorname{div}}% divergencia
...
%
\def\sop{\operatorname{supp}} % soporte
\def\uno{\mathbbm{1}} % funcion indicador
\def\sign{\operatorname{sign}} % funcion signo
%\def\un{\mathbbm{0}} % vector 0
\def\arccos{\operatorname{arccos}} % arcoseno
\def\igualc{\stackrel{\mathrm{conv}}{=}} % igualdad por convencion
\def\iguald{\stackrel{\mathrm{d}}{=}} % igualdad en distribucion
\def\niguald{\stackrel{\mathrm{d}}{\neq}} % diferente en distribucion
...
\newcommand{\bino}[2]{\Big( \hspace{-1mm} \protect\begin{array}{c} #1 \\[-1mm] #2 \protect\end{array} \hspace{-1mm} \Big)}
...
% cuzada
\newcommand{\Hcruz}[2][]{
H_{\mathrm{cruz}}\ifthenelse{\isempty{#1}}{}{\left( #1 \left\| #2 \right. \right)}
}
%
% H_\phi
\newcommand{\hphi}[1][]{
