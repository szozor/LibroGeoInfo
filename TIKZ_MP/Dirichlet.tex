...
\draw[->,>=stealth] (0,-.25,0)--(0,{\dx+.5},0) node[below right,scale=.9]{$x_2$}; \node at (0,\dx,0)[below,scale=.8]{$1$};
...
\begin{axis}[
    ...
    color=black,
    samples=60,
    xlabel=$\widetilde{x}_1$,
    ylabel=$\widetilde{x}_2$,
...
%
% Marginales
\addplot3 [domain=0:1,samples=51, samples y=0, thick, smooth, color=black] (x,1,{(x^(\au-1))*((1-x)^(\ad+\at-1))/\Bu});
\addplot3 [domain=0:1,samples=51, samples y=0, thick, smooth, color=black] (0,x,{(x^(\ad-1))*((1-x)^(\au+\at-1))/\Bd});
%
