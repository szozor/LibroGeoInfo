...
%
\pgfmathsetmacro\r{3.5} % rayo del circulo (d=2) y de la esfera (d=3)
%
%
...
node[pos=0.25,left,scale=.75] {$\boldsymbol{\theta_1}$}
({projx(\proptu*\xp,0)},{projy(\proptu*\xp,0,\proptu*\zp)});
%
%
% notacion del angulo theta_2
\pgfmathsetmacro{\propp}{.55} % "rayo" para dibujar el angulo
