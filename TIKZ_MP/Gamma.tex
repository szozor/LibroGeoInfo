...
\draw[thick,dash dot,domain=0:\mx,samples=100] plot ({\x*\sx},{\sy*exp(-\x)});
\draw[thick,dashed,domain=0:\mx,samples=100] plot ({\x*\sx},{\sy*\x*exp(-\x)});
...
\draw[thick,dash dot,domain=0:\mx,samples=100] plot ({\x*\sx},{\sy*(1-exp(-\x))});
\draw[thick,dashed,domain=0:\mx,samples=100] plot ({\x*\sx},{\sy*(1-(1+\x)*exp(-\x))});
