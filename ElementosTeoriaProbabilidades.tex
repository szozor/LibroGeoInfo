...
\item Las  nociones de convergencia  (aparece en casos  limites de leyes,  en el
  TCL)
%
\item  Teorema  cntral  limite  \&  Lindenberg-Feller (el  nombre  viene  de  un
  documento de G. P\'olya en 1920, titulado ``\"Uber den zentralen Grenzwertsatz
  der Wahrscheinlichkeitsrechnung und  das Momentenproblem'' (``Sobre el teorema
  del  l\'imite central  del c\'alculo  probabil\'istico  y el  problema de  los
  momentos; el teorema es central\ldots \cite{Cam86}).
%
\item Definicion de los cumulentes (ver momentos)
%
\item Cotas de Chernoff con la MGF o PGF
%
\item Prueba inversion Fourier en el caso con densidad
%
...
%
\item Hablar de simulaci\'on (inversion OK; mezcla? rejecci\'on? multivariada via la condicional?) VEr Kotz vol 2 por ejemplo
\end{itemize}
}
