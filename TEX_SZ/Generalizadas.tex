...
\end{proof}
%
Este lema  prueba que, dando vinculos ``razonables'',  la $(h,\phi)$-entrop\'ia es
...
\item \SZ{Con  $K =  1$, \ $\X  = \Rset^d$  \ y \  $M(x) = x  x^t$ (visto  con $d^2$
  vinculos), y $\phi(u) = u^\beta$ (R\'enyi o Havrda-Charv\'at-Dar\'oczy), la  distribuci\'on  de  entrop\'ia  m\'axima  es \SZ{Student; Costa and son on. Gausiana se recupera caso l\'imite}.}
\end{itemize}
