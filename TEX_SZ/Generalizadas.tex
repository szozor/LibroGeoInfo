...
donde  $p  \otimes  q$  es   el  producto  de  Kronecker~\footnote{Ver  nota  de
  pie~\ref{foot:SZ:Kronecker}      pagina~\pageref{foot:SZ:Kronecker}},      \ie
...
\label{sec:SZ:JensenBregmanCzizar}
