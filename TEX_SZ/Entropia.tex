...
natural unidades o  nats, si es el de  base 10, $H$ es en  d\'igitos decimales o
...
\item\label{prop:SZ:cotamaxima} {\it Maximalidad:}  La entrop\'ia es acotada por
  ...
  %
  \leyenda{Entrop\'ia  binaria  (de una  variable  de  Bernoulli) $h(\lambda)  =
...
ilustrado en la figura Fig.~\ref{fig:SZ:ensemblerearreglado}-b
  ...
  \leyenda{(a):  Ilustraci\'on  del rearreglo  sim\'etrico  $\P^\downarrow$ de  un
    ...
    $p_X^\downarrow(x)$;  adem\'as, por construcci\'on,  las superficias  en grise
    son iguales.}
  %
