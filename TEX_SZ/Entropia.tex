...
\modif{$H$  es  el   equivalente  de  la  entrop\'ia  de   Gibbs  en  mec\'anica
  estad\'istica (denotata  \ $S$  \ en este  marco), como  lo hemos visto  en la
  ...
  cap\'itulo).}  La  letra  $H$   viene  del  teorema-H  debido  a\ldots  Ludwig
...
\item\label{Prop:SZ:permutacion}   {\it  Invariance  bajo   una  permutaci\'on:}
  ...
  la     $i$-\'esima      componente     de     $p_X^\downarrow$     \modif{(ver
    secci\'on~\ref{Ssec:MP:VADiscreta},
    definici\'on~\ref{Def:MP:Mayorizacion})},
  %
  \[
...
\times  \Y$  de  cardinal $\alpha  \beta$  tal  que  se define  naturalmente  la
