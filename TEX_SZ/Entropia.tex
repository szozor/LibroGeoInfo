...
(denotata   \   $S$  \   en   este   marco),  como   lo   hemos   visto  en   la
secci\'on~\ref{Ssec:MP:FamiliaExponencial}.   La letra  $H$ viene  del teorema-H
debido a\ldots Ludwig Boltzmann~\cite{Jay65, Mer10, Mer18}.
