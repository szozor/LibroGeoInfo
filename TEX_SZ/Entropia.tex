...
diferencial). La entrop\'ia de $X$ con respecto a $\mu$ se escribe como
  %
  \[
  \modif{H(X \| \mu) \equiv H(p_X \| \mu) \equiv H(P_X \| \mu) = - \int_\X p_X(x) \, \log p_X(x) \, d\mu(x) = - \int_\X \log\left( \frac{dP_X}{d\mu}(x) \right) \, dP_X(x)}
  \]
  %
\end{definicion}
%
Insistimos en el hecho de que se puede entender esta definici\'on para cualquier
  ...
  cualquiera.  \modif{\bf  En general,  tratando  de  la  medida de  Lebesgue  o
  $\mu_\X$ discreta, se quita la medida $\mu$ et la escritura formal de $H$.}
