...
Un  canal es  dicho uniforme  en  salida si  $\un$  autovector de  la matriz  de
transici\'on, $\Pi  \un \propto  \un$, \ie si  la entrada de  un canal  con esta
transici\'on es uniforme, la salida tambi\'en. Necesariamente, $\Pi \un = \frac{|\X|}{|\Y|} \, \un$.

Cuando $|\Y|=|\X|$,  el autovalor  es igual  a uno  y la  matriz est  dicha {\em
bi-estocastica} (recordar que es estochastica, $\un^t \Pi = \un^t$).
\end{definicion}
...
%
\[
\Pi = \begin{bmatrix} 1 - \varepsilon & 0 \\ \varepsilon & \varepsilon \\ 0 & 1 - \varepsilon \end{bmatrix}
\]
%
...
%
\[
p_Y =  \begin{bmatrix} r (1-\varepsilon) \\ \varepsilon \\ (1-r) \varepsilon \end{bmatrix}
\]
%
as\'i que, claramente, cuando $\varepsilon \ne \frac13$ no se puede alcanzar una
distrinuci\'on de salida uniforme. De hecho,  se calcula la entrop\'ia de salida
como
%
\[
...
Un ejemplo particular de canal sim\'etrico es un canal de matriz de transici\'on dicha {\em circulante},
%
\[
\Pi = \begin{bmatrix}
  a_1   &   a_n  & a_{n-1} & \cdots & a_2 \\
%
  a_2   &   a_1  &   a_n  & \cdots & a_3\\
%
  a_3   &   a_2  &   a_1  & \cdots & \vdots\\
%
