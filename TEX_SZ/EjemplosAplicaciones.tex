...
termino con  factores de Lagrange es  tambi\'ien convexo), as\'i que  existe una
...
\]
%
con  \  $\L(x,u,v)  \in  C^1\left(   \Rset^d  \times  \Rset  \times  \Rset^d  \,
, \,  \Rset \right)$.  Del  enfoque de  Euler-Lagrange, generalizado en  el caso
...
%
\[
\frac{\partial L}{\partial  f} - \div_x  \left( \nabla_{\! f'} \L  \right) =
0 \qquad \mbox{donde} \qquad f' = \nabla_x f
\]
%
%
...
%
\[
\frac{\partial  \L}{\partial  f}   -  \sum_{j=1}^d  \frac{\partial}{\partial
x_j} \left( \frac{\partial \L}{\partial f'_j} \right) = 0
