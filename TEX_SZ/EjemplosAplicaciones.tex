...
\begin{proof}
  ...
  porque \ $p$ \ y \ $p_{\mathrm{fm}}(x)$ \ tienen los mismos momentos y el cuarto tambi\'en va a dar cero por el teorema de la divergecia~\footnote{\SZ{A dar}}~\cite{toto}. En conclusi\'on,
  %
  \[
  \int_\X \left\| \frac{\nabla_x \, p(x)}{p(x)} - \frac{\nabla_x
