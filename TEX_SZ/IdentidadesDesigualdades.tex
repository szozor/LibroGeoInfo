...
del integrande  con respecto a  $p$; en el  caso discreto, se anula  realmente un
gradiente con respecto a los componentes de $p$. Reparametrizando los factores de
...
%
  ...
  respecto a $\theta$ sobre $\Theta$.  La matriz de Fisher, de tama\~no $m \times
  m$, es definida por
  %
  \[
...
\item $J_\theta$  \ y  \ $J$  \ son convexas  en el  sentido que  para cualquier
  ...
  considerando el gradiente con respecto a \ $\theta$ (resp. a \ $x$) tratando de
