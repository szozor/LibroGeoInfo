...
--(1,0);
%
\draw (.5,0)--(.5,-.05) node[below]{\small $\alpha^\opt$};
\draw (1,0)--(1,-.05) node[below]{\small 1};
\draw (0,\Capa)--(-.05,\Capa) node[left]{\small $C$};
\draw (0,1)--(-.05,1) node[left]{\small 1};
\end{scope}
