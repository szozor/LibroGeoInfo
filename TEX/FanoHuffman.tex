...
% -----
%
\draw (-2,-1) -- (-3,-2) node[scale=.8]{$\bullet$}
...
%
\draw (-2,-1) -- (-1,-2) node[scale=.8]{$\bullet$}
...
%
\draw (2,-1)-- (3,-2) node[scale=.8]{$\bullet$}
node[above,scale=.85]{$11$};
\draw (3.1,-1.95) node[right,scale=.85]{$\{ x_4 , x_5 \}$};
%
% -----
%
\draw (3,-2)-- (2.25,-3) node[scale=.8]{$\bullet$}
...
%
\draw (3,-2)-- (3.75,-3) node[scale=.8]{$\bullet$}
