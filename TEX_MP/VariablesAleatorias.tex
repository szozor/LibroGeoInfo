...
$d =  2, \:  \nu =  6$, y  la de la  ley gausiana  esferica $q_X$  de covarianza
$\frac{\Tr                  \Sigma_X}{d}                 I$                 (ver
secci\'on~\ref{Sec:MP:EjemplosDistribucionesProb}), lo  que ilustra graficamente
la relaci\'on de mayorizaci\'on $q_X \prec p_X$.
...
%
  \leyenda{(a) Densidad de  probabilidad $p_X$ del ejemplo~\ref{Ej:MP:Rearreglo}
    ...
    Equivalenbte continua de  la curva de Lorentz para  la densidad $p_X$ (linea
    llena) y la  gausiana esferica $q_X$ de covarianza de misma  traza que la de
    $p_X$, ilustrando una relaci\'on de mayorizaci\'on $q_X \prec p_X$.}
