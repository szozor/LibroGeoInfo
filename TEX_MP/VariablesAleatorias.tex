...
\& teorema~4.1.1]{AthLah} por ejemplo~\footnote{Basicamente, se muestra de que \
  ...
  p(\widetilde{x})$.}:
%
\begin{teorema}[Descomposition de una medida de probabilidad]
...
\subseccion{Unas palabras sobre los vectores aleatorios complejos}
\label{Ssec:MP:VAComplejos}


\

\aver{\SZ{No toque todav\'ia. Me (SZ) voy a encargar de eso. Se puede hacerlo con vectores. 

Definici\'on formal; Biyecci\'on $\Cset^d$ y $\Rset^{2 d}$; Caso circular\ldots}
