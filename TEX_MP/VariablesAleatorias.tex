...
\item Sean $U$  \ y \ $V$ \ variables continuas,  independientes, de densidad de
  ...
  representada   figura  Fig.~\ref{fig:MP:ProbaMixta}:   es   ni  discreta,   ni
  continua. Entonces, a pesar de que $\X =  [0 \, ; \, 1)$, un intervalo, $X$ no
  es continua (y tampoco no puede ser discreta).
  %
  \begin{figure}[h!]
