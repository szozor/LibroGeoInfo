...
\begin{proof}
  ...
  iguales) lo  que cierra la  prueba~\footnote{De hecho, se  puede sencillamente
    ...
    es conocido como {\it leyes de de Morgan}~\cite{AthLah06, Coh13}.}.
\end{proof}
...
\begin{definicion}[Variable aleatoria real]
  ...
  es frecuentemente llamada {\it  distribuci\'on de probabilidad} de la variable
  aleatoria $X$. En lo que sigue, escribiremos los eventos
  %
 \[
...
univariado, se define este vector de la manera siguiente\modif{:~\cite{AthLah06,
    Coh13, Bre88}
%
...
\, b_d]$, \ie la  funci\'on de repartici\'on multivariada~\cite{AthLah06, Coh13,
  Bre88}:
%
\begin{definicion}[Funci\'on de repartici\'on mutlivariada]
