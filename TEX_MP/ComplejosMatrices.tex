...
probabilidades, momentos o funciones generadoras. Los primeros estudios de tales
matrices  se encuentrand  entre los  a\~nos 1928  y  1955~\cite{Wis28, NeuGol47,
  Wig55}.  Desde   esta  \'epoca,  fueron  estudiados   intensivamente  que  sea
formalmente   o   en   el   contexto   de   grande   dimensi\'on~\cite{MarPas67,
  BouPas95}. Los vamos a ver brevemente,  dejando el lector a libros o articulos
...
\item Las generadoras son respectivamente equivalentes a las de $\widetilde{Z}$,
  ...
  funci\'on   caracteristica  tomando  el   logaritmo  $\Psi_X(\omega)   =  \log
...
vector $\mu$, conservando solamente la  nulidad de la pseudo-covarianza. Como li
v\'imos tranatdo de vectores circulares, tenemos la implicaci\'on siguiente:
...
\item Los  momentos y  cumulantes se definen  como en  el caso de  vectores; Por
  ...
  \]
  %
  donde \ $\cdot^{\otimes k}$ \ es \ $k$ \ veces el \modif{producto interno (ver
...
\item  Se puede  escribir  tambi\'en  las funciones  generadoras  con una  forma
  ...
  \]
  %
  De nuevo  se define la  secunda funci\'on caracteristica tomando  el logaritmo
