...
\SZ{
% --------------------------------- Uniforme
\subsubseccion{Ley Uniforme}
\label{Sssec:MP:Uniforme}
}
...
%\hline
%
%Momento factorial & $\Esp\left[ (X-k+1)_k \right] = p^k \un_{\{0 \, , \, 1 \}}(k)$\\[2mm]
%\hline
%
Promedio & $ m_X = p$\\[2mm]
\hline
...
%\hline
%
%Momento factorial & $\Esp\left[ (X-k+1)_k \right] = \frac{n!}{(n-k)!} p^k \un_{\{ 0 \, , \, \ldots \, , \, n \}}(k)$\\[2mm]
%\hline
%
...
%\hline
%
%Momento factorial & $\Esp\left[ (X-k+1)_k \right] = \frac{p^{k-1} k!}{(1-p)^k}$\\[2mm]
%\hline
%
...
%\hline
%
%Momento factorial & $\Esp\left[ (X-k+1)_k \right] = \lambda^k$\\[2mm]
%\hline
%
...
\hline
%
Dominio de definici\'on & $\D = [a \, ; \, b]$\\[2mm]
\hline
%
...
%\hline
%
%Momento factorial & $\Esp\left[ (X-k+1)_k \right] = ?$\\[2mm]
%\hline
%
...
son representadas en la figura Fig.~\ref{Fig:MP:Uniforme}.
%
\begin{figure}[h!]
...
Variables beta tiene tambi\'en unas propiedades notables. Primero, por cambio de
variables, se demuestra el lema siguiente:
%
