\SZ{Cambio de variable multivariado: citar Mukhopadhyay}
...
%
\begin{proof}
  \SZ{Usando la formula de esperanza total ec.~\ref{Th:MP:EsperanzaTotal}, se escribe}
  %
  \begin{eqnarray*}
...
%
\begin{definicion}[funci\'on   generadora   de     momentos]\label{Def:MP:GeneradoraMomentos}
  % 
...
\begin{definicion}[funci\'on   caracter\'istica]\label{Def:MP:FuncionCaracteristica}
  % 
...
\SZ{hablar de la cota de Chernoff con la pgf?}
