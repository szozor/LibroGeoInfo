...
unos  $A$.   Entonces  $P_X  =   (1-P(A))  \delta_0  +  P(A)   \delta_1$.  Luego
...
probar directamente  saliendo de~\footnote{Hay que  tener precauciones separando
  ...
  partes, pero hay que mirar bien  el comportamiento de $t \mapsto t (1-F_X(t))$
  al infinito.} $P(X = n) = P(X>n)- P(X>n-1)$.
