...
%
  ...
  anterior, la ley de \ $Y$ \  es entonces completamente determinada por la de \
  $Y_\vcol^t Y_\vcol = \| Y \|_F^2$ (siendo la ley de $Y$ la ley conjunta de sus
  componentes). Sea  ahora \ $Y_\vlin  \equiv \begin{bmatrix} Y'_1 &  \cdots &
    Y'_d \end{bmatrix}^t$.  Claramente, la ley  de \ $Y$ \  siendo completamente
  determinada  por  la de  \  $\|  Y  \|_F^2$, equivalentemente,  esta  \'ultima
  determina completamente la ley de \ $Y_\vlin$. Siendo tambi\'en $\| Y \|_F^2 =
  Y_\vlin^t     Y_\vlin$,     se     concluye     que    \     $Y_\vlin     \sim
  \ED(0,I,\varphi_{Y_\vlin})$:   $\ED_\vcol   \subset   \ED_\vlin$.   El   mismo
  razonamiento permite decir que $\ED_\vlin \subset \ED_\vcol$, lo que cierra la
  prueba.
...
\leyenda{Ilustraci\'on de los v\'inculos entre  cada clase de matriz aleatoria a
  ...
  las simetrias  izquierdas, y adentra  de las lineas punteadas  representan las
  simetrias derechas (en linea mixta  se representa cuando son en ambas izquiera
  y  derecha).   La parte  grise  claro  conjuntamente  a la  oscuro  representa
  $\ED_\col$ y la parte grise mediano conjuntamente a la grise oscuro representa
  $\ED_\bil$,  siendo la  parte grise  oscura la  intersecci\'on  $\ED_\bil \cap
  \ED_\col = \ED_\vcol = \ED_\vlin = \ED_\bil \cap \ED_\lin$.}
...
%
  \item \SZ{ME TENGO QUE FIJAR BIEN... a\'un que sea seguro $X  \sim \ED_\simed(m,\Sigma,\varphi_X) \:\:  \Leftrightarrow \:\: X
      ...
      independiente  de   $\Lambda_\simed$   matriz  aleatoria  diagonal.}
