...
%
  ...
  $\Mat_{d,d}(\Rset)$, necesariamente~\footnote{La matriz  bloc se escribe \ $O'^t
    ...
    para que  no haya confusi\'on con el  producto extreno, a pesar  de que haya
...
\item  \SZ{La  ley  de  Wishart,  secci\'on~\ref{Sssec:MP:Wishart}  partenece  a
    $\ED_\bil$ pero no es ni en $\ED_\vcol$ ni en $\ED_\vlin$.}
%
...
%      corrolario~\ref{Lem:MP:MediaCovarianzaEliptica}}~\cite{Kri76}
%
\item  Teorema~\ref{Teo:MP:TranformacionAfinEliptica}  en:  \  $X \,  \sim  \,
    \ED_\izq(m,\Sigma,\Phi_X) \quad \Rightarrow
    \quad A X B + C \: \sim \: \ED_\izq(A m B + C , A \Sigma A^\dag , \varphi_Z)$;
%  %
%  \item Teorema~\ref{Teo:MP:ProyeccionComponentesEliptica} en: Sea \ $Z$, vector
