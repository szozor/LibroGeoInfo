...
\begin{definicion}[Vector esf\'ericamente invariante]
...
\begin{proof}
  ...
  Laplace-Stieltjes~\footnote{Por     definici\'on,    la     transformada    de
    ...
    \LS[\mu](s)  =  \sum_i  \alpha_i  e^{-s  t_i}$ \  conocido  como  series  de
...
%
\begin{proof}
  Para \ $U$ \ uniforme sobre la  esfera, del desarollo en series de la funci\'on
  ...
  series de terminos todos positivos converge uniformamente. Por consecuencia, se
