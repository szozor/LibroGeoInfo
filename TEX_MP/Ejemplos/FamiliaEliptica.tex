...
La mayoria  de estos  resultados se  extienden al caso  complejo, con  ahora $Z$
esfericamente invariante si no cambia por transformaci\'on lineal unitaria, \ $H
Z \egald Z$  \ con \ $H$  \ unitaria, $H H^\dag =  H^\dag H = I$.  Ahora, lo que
juega el rol de  esfera va a ser la esfera compleja  $d$-dimensional \ $\{ u \in
\Cset^d \tq u^\dag u = 1 \}$. Ver~\cite{} para tener m\'as detailles.
