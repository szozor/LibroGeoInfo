...
%
  ...
  {\em transformada  de Hankel}  de orden \  $\frac{d}{2}-1$~\cite{Lor54, Pou99,
    Pou10}. A veces, la transformaci\'on dando \ $\varphi_X\left( w^2 \right)$ \
  a partir de \ $d_X\left( r^2 \right)$ \ es llamada {\em transformada de Hankel
    modificada} de orden \ $\frac{d}{2}-1$.
  ...
  (modificada)~\cite{Nus73, ChoHai70}
  %
  \[
...
%
  ...
  %
  \item \SZ{Mezcla de Student con carac~\ref{Teo:MP:MezclaStudentRCaracteristica}, secci\'on~\ref{Sssec:MP:StudentR}};
  %
