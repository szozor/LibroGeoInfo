...
{\em escala}). \SZ{Cuando $a \in \Nset^*$ es entero, la ley es a veces conocida como ley de Erlang~\cite{} A. K. Erlang, a Danish telephone engineer who is considered the founder of queueing theory Cf. Cox} Las caracter\'isticas son:
...
\hline
%
\modif{Sesgo} & $\displaystyle \gamma_X = \frac2{\sqrt{a}}$\\[2mm]
\hline
%
...
como distribuci\'on a priori conjugado~\footnote{En la inferencia Bayesiana, nos
  ...
  una distribuci\'on de Poisson, pero con el par\'ametro \ $\lambda$ \ desconocido
  ...
  posterior,   se   puede   actualizar   solamente  los   par\'ametros   (llamados
  hiperpar\'ametros).    \SZ{Ver    nota    de    pie    en    el    cap    2    a
    modificar}.\label{Foot:MP:BayesPrior} } del par\'ametro $\lambda$ de la ley de
Poisson~\cite{Rob07}.
