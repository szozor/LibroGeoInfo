...
posible con
%
% $M = \begin{bmatrix} \alpha & \beta \\ 0 & \gamma \end{bmatrix}$ \ da \ $M M^t
% =    \begin{bmatrix}    \Sigma_X   &    \Sigma_{XY}    \\   \Sigma_{XY}^t    &
%   \Sigma_Y \end{bmatrix} = $\begin{bmatrix}  \alpha \alpha^t + \beta \beta^t &
%   \beta \gamma^t \\  \\gamma \beta^t & \gamma \gamma^t  \end{bmatrix}$. Eso da
% por   ejemplo  $\gamma   =   \Sigma_Y^{\frac12}$,  \   $\beta  =   \Sigma_{XY}
% \Sigma_Y^{-\frac12}$  \   y  \  $\alpha   =  \left(  \Sigma_X   -  \Sigma_{XY}
%   \Sigma_Y^{-1}  \Sigma_{XY}^t  \right)^{\frac12}$. Por  el  otro  lado, $A  =
% \alpha + \gamma - \imath \beta$ \ y \ $B = \alpha - \gamma + \imath \beta$, es
% decir
%
%
%
