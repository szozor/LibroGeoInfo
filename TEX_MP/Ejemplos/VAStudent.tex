...
\hline
%
\modif{Sesgo} (caso escala) & $\displaystyle \gamma_X = 0$ \ si \ $\nu > 3$; \ no
...
\begin{proof}
  ...
  usando   la  formula   de   Stirling~\footnote{Ver nota de pie~\footref{Foot:MP:Stirling}}  para \ $\log\Gamma(z)  = \left(  z -
