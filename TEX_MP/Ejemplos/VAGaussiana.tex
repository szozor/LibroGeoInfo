...
\item {\bf  Ensemble Gausiano Ortogonal} (GOE para  Gaussian Orthogonal Ensemble
  ...
  ley,  o  a~\cite{Car83,  Meh04,  AndGui10,  LivNov18} para  un  estudio  m\'as
  sistematico  y  el  v\'inculo  con  la  f\'isica.   Se  extiende  para  $\X  =
  \Her_d(\Cset)$  (ensembles gausianos  unitario  o  GUE en  ingles)  y al  caso
