...
problema~\cite{Lap09, Lap09:Supp, Lap20, Pea24, Hal06}.  De hecho, apoyandose en
trabajos de  de Moivre, la formaliz\'o  antes y m\'as  claramente Laplace, quien
revandic\'o entonces su partenidad (ver por ejemplo~\cite{Pea20}). Por eso, esta
ley es tambi\'en conocida como ley de Laplace-Gauss.
...
referirse  al trabajo  de Laplace  de  18P9 o  de 1912~\cite{Lap09,  Lap09:Supp,
...
central\ldots~\cite{Pol20,      Cam86}).      Se      enuncia     de      manera
...
%
  ...
  independientes, de  misma ley, y que admiten  un promedio $m$ y  una matriz de
  covarianza $\Sigma$. Entonces
  %
  \[
  \frac{1}{\sqrt{n}} \sum_{i=1}^m \left( X_i  - m \right) \limitd{n \to +\infty}
  Y \sim \N\left( 0 , \Sigma \right)
  \]
  %
...
prueba.  Dejamos el  lector a  libros m\'as  especializados como~\cite{AshDol99,
  Bil12, AthLah16, Lin22}.
% Lindeberg 1920

\begin{teorema}[Teorema de Lindenberg-Feller]
%
