...
p_X(x) = 
  \]
  %
  \SZ{Aparece  que  el  par\'amtetro natural  es  $\eta  =  $ y  le  estadistica
    suficiente correspondiente es $S(x) = $.}
\end{ejemplo}
...
\SZ{Pasar todas las distribuciones vistas y decir la cuales son el la familia exponencial. Primero 2 ejemplos emfatizado: la gausiana (es),}
