...
Vectores  de  distribuci\'on   multinomial  tienen  unas  propiedades  notables,
parecidas a las de la binomial:
%
\begin{lema}[Efecto de una permutaci\'on]\label{Lem:MP:PermutacionMultinomial}
%
  Sea \ $X \, \sim \, \M(n,p), \: p \in \Simp{k-1}$ \ y \ $\Pi \in \mathfrak{S}_k(\Rset)$ \
...
\begin{proof}
  ...
  aplicando el teorema~\ref{Teo:MP:PropiedadesFuncionCaracteristica}.
\end{proof}
%
Adem\'as ley  multinomial exhibe una stabilidad remplazando  dos componentes por
su suma:
%
\begin{lema}[Stabilidad por agregaci\'on]\label{Lem:MP:StabSumaMultinomial}
%
