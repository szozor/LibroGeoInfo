...
de tiros parteneciendo en la primera clase (n\'umero de excitos).
...
%\hline
%%
%\SZ{Curtosis por exceso} & $\displaystyle \widebar{\kappa}_X = $\\[2mm]
%\hline
%
...
\SZ{Otros ilustraciones para otros $n, k, m$? Poner el Sesgo (ya lo tengo)? El Curtosis (lo tengo que simplificar)?}
