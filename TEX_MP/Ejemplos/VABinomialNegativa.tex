...
\hline
%
\modif{Asimetr\'ia} & $\displaystyle \gamma_X = \frac{1 + p}{\sqrt{r p}}$ \quad para \ $p \ne 0$ \ (ver m\'as adelante)\\[2mm]
\hline
%
...
\SZ{Otras ilustraciones para otros $r, p$?}
...
Esta distribuci\'on se  generaliza para \ $r \in \Rset_{0,+}$ \  pero se pierde la
interpretaci\'on que v\'imos en el p\'arafo anterior.

Nota: cuando \ $p =  0$ \ la variable es cierta \ $X =  r$.  De nuevo, siendo la
varianza cero  en este  caso, no se  puede definir  ni asimetr\'ia (pero  no hay
asimetr\'ia), ni curtosis (pero la ley no tiene colas, \ie colas livianas).
