...
fijo~\cite[Cap.~3]{Poi37},~\cite{Hal90}.    Se  intereso   en  su   estudio  del
comportamentio  probabilistico del conteo  de experiencia  de Bernoulli  bajo la
...
\begin{proof}
  ...
  Stirling~\footnote{De hecho, esta  formula es probablemente debida previamente
    a  A.  De  Moivre~\cite{Moi56,  Pea24,  Cam86, Dut91},  y  fue mejorada  por
