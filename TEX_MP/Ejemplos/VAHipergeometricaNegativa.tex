\subsubseccion{Ley hipergeom\'etrica negativa}
...
%
\begin{figure}[h!]
\begin{center} \input{TIKZ_MP/HipergeometricaNegativa} \end{center}
%
\leyenda{Ilustraci\'on de  una distribuci\'on de  probabilidad hipergeom\'etrica
  negativa (a), y  la funci\'on de repartici\'on asociada (b), con  \ $n = 100$,
  \quad $k = 12$, \quad $r = 40$.}
