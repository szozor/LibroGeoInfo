...
$\Unit_d(\Cset) = \left\{ Q \in \Mat_{d,d}(\Rset) \tq Q Q^\dag = Q^\dag Q = I
\right\}$.\\[2.5mm]
\hline
%
...
\hline
%
$\diag$ & Vector formado de los elementos diagonales su argumento, matriz cuadrada,\vspace{1mm}\newline para \ $\displaystyle M = \protect\begin{bmatrix}
  m_{1,1}  & \cdots & m_{1,d} \\
  \vdots  & \vdots & \vdots \\
  m_{d,1}  & \cdots & m_{d,d}
\end{bmatrix}\protect \in \Mat_{d,d}(\Kset), \quad \diag(M) = \protect\begin{bmatrix} m_{1,1} \\ m_{2,2} \\ \vdots \\ m_{d,d}
