...
\hline
%
$P_d(\Kset)$ & Conjunto de matrices herm\'iticas semidefinida
positivas:\vspace{1mm}\newline $P_d(\Kset) = \left\{ M \in H_d(\Kset) \tq
\forall \, x \in \Kset^d, \: x^\dag M x \ge 0 \right\}$.\\[2.5mm]
\hline
%
$P_d^+(\Kset)$ & Conjunto de matrices herm\'iticas definida
positivas:\vspace{1mm}\newline $P_d^+(\Kset) = \left\{ M \in H_d(\Kset) \tq
...
\hline
%
$\O_d(\Rset)$ & Conjunto de matrices ortogonales (groupo ortogonal):\vspace{1mm}\newline $\O_d(\Rset) = \left\{ Q \in \M_{d,d}(\Rset) \tq
Q Q^t = Q^t Q = I \right\}$.\\[2.5mm]
\hline
%
$\U_d(\Cset)$ & Conjunto de matrices unitarias:\vspace{1mm}\newline $\U_d(\Cset) = \left\{ Q \in \M_{d,d}(\Rset) \tq
Q Q^\dag = Q^\dag Q = I \right\}$.\\[2.5mm]
\hline
%
