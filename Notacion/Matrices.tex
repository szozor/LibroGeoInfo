...
\hline
%
$\mathfrak{S}_d(\Kset)$ & Conjunto de las matrices de permutaciones de \
$\M_{d,d}(\Kset)$\vspace{1mm}\newline $\mathfrak{S}_d(\Kset) = \left\{ \Pi =
\protect\begin{bmatrix} \un_{\sigma(1)} & \cdots &
\un_{\sigma(d)} \end{bmatrix}\protect, \quad \sigma \in \mathfrak{S}_d
\right\}$\vspace{1mm}\newline Tiene exactamente un $1$ en cada linea y en cada
columna, y $0$ en los otros componentes.\\[2.5mm]
\hline
%
