...
\protect$f = \begin{bmatrix} f_1 & \cdost & f_d \end{bmatrix}^t: \Rset^d \mapsto \Rset^d, \quad \div f = \sum_{j=1}^d \frac{\partial f_j}{\partial x_j} = \Tr \left( \Jac_f \right)$\protect\newline Se denota $f' = \frac{df}{dx}$ cuando $d = 1$\\[2.5mm]
\hline
%
