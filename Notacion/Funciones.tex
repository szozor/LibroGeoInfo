...
%
$\supp$ & Soporte de una funci\'on, $\supp f = \overline{\{ x tq f(x) \ne 0\}}$
...
\hline
%
$\un_A$ & Funci\'on indicadora o indicatriz del conjunto \ $A$: \ $\un_A(x) =
...
%
$\nabla_x$ & Gradiente con respecto a $x$, para
...
\modif{Se  refier\'a a~\cite{AbrSte70,  AndAsk99, GraRyz15,  GraKnu94, SriKar85,
    Hum22,  App25,  AppKam26,  Erd37,  Erd40,  Wat22,  GraMat95,  Mac98,  And03,
