...
\hline
%
$\notin$ & ``no es elemento de'' o ``no partenece a''.\\[2.5mm]
\hline
%
$\subset$ & ``es incluido en''\vspace{1mm}\newline $B \subset A$ significa que el conjunto
$B$ es adentro del conjunto $A$: $x \in B \Rightarrow x \in A$.\vspace{1mm}\newline Son posiblemente iguales.\\[2.5mm]
\hline
%
$\varsubsetneq$ & ``es estrictamente incluido en''\vspace{1mm}\newline $B \varsubsetneq A$ significa que el conjunto
$B$ es estrictamente adentro del conjunto $A$: $x \in B \Rightarrow x \in A, \quad \exists \, y \in A \et y \notin B$;\vspace{1mm}\newline No son iguales.\\[2.5mm]
\hline
%
% subseteq
%
