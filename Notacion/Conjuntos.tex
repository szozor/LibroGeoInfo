...
\hline
%
$\CM_n$ & Conjuntos (convexo) de las funciones \ $f: \Rset_+ \mapsto $ \
continuas y \ $n$ \ veces diferenciables tal que \ $\forall \, k = 0 , \ldots ,
n, \:\: (-1)^k f^{(k)} \ge 0$.\\[2.5mm]
\hline
%
$\CM$ & Conjuntos (convexo) $\displaystyle \bigcap_{n=0}^{+\infty} \, \CM_n$ de
las funciones \ $f: \Rset_+ \mapsto \Rset$ \ continuas, infinitemente
diferenciable tal que \ $\forall \, k \in \Nset, \:\: (-1)^k f^{(k)} \ge 0$.
\end{notation}
